...
//    {
//        Mockito.doThrow(IllegalArgumentException.class).when(mockedRentalDao).create(null);
...
//    {
//        Mockito.doThrow(IllegalArgumentException.class).when(mockedRentalDao).edit(null);
...
//    {
//        Mockito.doThrow(IllegalArgumentException.class).when(mockedRentalDao).get(Long.MIN_VALUE);
...
//    {
//        Mockito.doThrow(IllegalArgumentException.class).when(mockedRentalDao).delete(null);
